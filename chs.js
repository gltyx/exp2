...
var cnItems = {
    ...
    "Once you reveal all the squares and flag all the mines correctly, you win the playing field, and the game announces it to you.": "一旦你展示了所有的方块并正确地标记了所有的地雷，你就胜利得了比赛场地，游戏会向你宣布。",
    ...
    "The AUTOMATION tab provides new game mechanics to automatically perform some repetitive actions in the game, such as reseting the board or revealing neighboring squares!": "自动化 选项卡提供了新的游戏机制来自动执行游戏中的一些重复操作，例如重置游戏板或显示相邻的方格！",
    "The revealed contents of  ": "揭露的内容",
    ...
    "Dividing by zero": "除以零",
    "Flag": "标记",
    "sadpanda": "悲伤熊猫",
    "Simulating traveling salesman": "模拟旅行推销员",
    "Treating shellshock": "治疗炮击",
    "We're all safe again": "我们又安全了",
    "Explosions": "爆炸",
    "Losses": "失败",
    "The revealed contents of  ": "揭露的内容",
    "Uh oh! The  ": "哦哦！ ",
    "Mining some bitcoins": "挖一些比特币",
    "WIN!": "胜利！",
    "KABOOOM!!!!!": "轰隆！",
    "Sweet!": "甜美！",
    "Taking the hobbits to Isengard": "带霍比特人去艾辛格",
    "Writing new reset messages": "编写新的重置消息",
    "Additional": "附加",
    "Auto Expand Board": "自动扩展游戏板",
    "Auto Flag Mines": "自动标记地雷",
    "Auto Purchase Hints": "自动购买提示",
    "Auto Reset Game": "自动重置游戏",
    "Auto Reveal Hints": "自动显示提示",
    "Auto Reveal Neighbors": "自动显示邻居",
    "Automatically flags the hidden mines around a square if there are no more hidden clear squares left around it.": "如果周围没有更多隐藏的透明方块，则自动标记方块周围的隐藏地雷。",
    "Automatically initiates game reset when the game is either won or lost.": "当游戏获胜或失败时自动启动游戏重置。",
    "Automatically makes a hint purchase when there are no other actions available.": "当没有其他可用操作时自动进行提示购买。",
    "Automatically purchases game width and game height expansions if affordable.": "如果负担得起，自动购买游戏宽度和游戏高度扩展。",
    "Automatically reveals any purchased hints.": "自动显示任何购买的提示。",
    "Automatically reveals the neighboring hidden squares if all the mines around it have been flagged.": "如果周围的所有地雷都已被标记，则自动显示相邻的隐藏方块。",
    "Board Automation": "游戏板自动化",
    "Cell Automation": "细胞自动化",
    "Enabled:": "启用：",
    ...
    "Advanced Achievements": "先进成就",
    "Allow making 1 mistake on a game and still winning it!": "允许在游戏中犯 1 个错误并仍然获胜！",
    "Auto Click Board": "自动点击板",
    "Automated Gameplay": "自动化游戏",
    "Automatically reveals cells on new games. Does not differentiate between mines and clear cells.": "自动显示新游戏的单元格。 不区分地雷和透明细胞。",
    "Board Size": "板尺寸",
    "Clicks On Board": "板载点击次数",
    "Gained": "获得",
    "Game Lose Streak": "连败",
    "Game saved!": "游戏已保存！",
    "Game Win Streak": "游戏连胜",
    "Games Lost": "输掉的比赛",
    "Games Started": "游戏开始",
    "Games Won": "赢得比赛",
    "Hours Offline": "离线时间",
    ...
    "milestones": "里程碑",
    "Minutes Playing": "分钟播放",
    "never": "从不",
    "Normal Achievements": "正常成就",
    "Score multiplier from achievements:": "成就分数乘数：",
    "Secret Achievements": "隐藏成就",
    "Speed up all automation by 20% per milestone!": "每个里程碑将所有自动化速度提高 20%！",
    "time every 1 minute": "次每1分钟",
    "times after reset": "次复位后",
    "times every 1 minute": "次每1分钟",
    "Total achievements score:": "总成就分数：",
    "Current number format is:  ": "当前数字格式：",
    "Current theme is:  ": "当前主题：",
    "Engineering": "工程符号",
    "Logarithmic": "对数",
    "Main": "首页",
    "Mixed Engineering": "混合工程",
    "Mixed Logarithmic": "混合对数",
...
var cnRegReplace = new Map([
    ...
    [/^(.+) days, (.+) hours, (.+) minutes, (.+) seconds ago$/, '$1天，$2小时，$3分钟，$4秒前'],
    ...
    [/^([\d\.]+) minutes, ([\d\.]+) second ago$/, '$1 分钟，$2秒前'],
    [/^([\d\.]+) minute, ([\d\.]+) seconds ago$/, '$1 分钟，$2秒前'],
    [/^([\d\.]+) hour, ([\d\.]+) minutes, ([\d\.]+) seconds ago$/, '$1 小时，$2分钟, $3秒前'],
    [/^([\d\.]+) hours, ([\d\.]+) minutes, ([\d\.]+) seconds ago$/, '$1 小时，$2分钟, $3秒前'],
    [/^([\d\.]+) days, ([\d\.]+) hours, ([\d\.]+) minute, ([\d\.]+) seconds ago$/, '$1 天，$2小时，$3分钟, $4秒前'],
    [/^([\d\.]+) days, ([\d\.]+) hours, ([\d\.]+) minutes, ([\d\.]+) seconds ago$/, '$1 天，$2小时，$3分钟, $4秒前'],
    [/^([\d\.]+) days, ([\d\.]+) hours, ([\d\.]+) minutes ago$/, '$1 天，$2小时，$3分钟前'],
    [/^([\d\.]+) Minutes Playing$/, '玩 $1 分钟'],
    [/^([\d\.]+) Hours Offline$/, '离线 $1 小时'],
    [/^([\d\.]+) Game Win Streak$/, '$1 连胜'],
    [/^([\d\.]+) Game Lose Streak$/, '$1 连输'],
    [/^([\d\.]+) elves$/, '$1 精灵'],
    [/^([\d\.]+) Click On Board$/, '在游戏板上点 $1 次'],
